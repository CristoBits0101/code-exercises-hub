<?php
    ...
    try 
    {
        ...
        $insertarQuery2 = "insert into usuarios(nombre, clave, rol) values('prueba2', 'prueba2', '1')";
        $insertarQuery3 = "insert into usuarios(nombre, clave, rol) values('prueba3', 'prueba3', '2')";
